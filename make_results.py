...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
@ray.remote
def make_results_cluster( oim, nfp, dir, nf, header, xs, ys, gamma, n_levels, lvl_sep_big, lvl_sep_l, size_sep_icl_l, size_sep_bcg_l, sbt_l, err_size, pixscale, physscale, rc, rc_pix, n_sig_gal, ricl, r_lsst):
    '''
    ...
    for lvl_sep in lvl_sep_l:
        ...
        r_trans_wavsep_kpc = measure_transition_radius(nfp = nfp + 'wavsep_', im_icl = icl, im_bcg = iclbcg, n_bins = 300, pixscale = pixscale, physscale = physscale )
    ...
    for size_sep in size_sep_bcg_l:
        ...
        r_trans_sizesep_kpc = measure_transition_radius(nfp = nfp + 'sizesep_', im_icl = icl, im_bcg = iclbcg, n_bins = 300, pixscale = pixscale, physscale = physscale )
...
if __name__ == '__main__':
    ...
    size_sep_bcg_l = [ 450 ] # separation radius bcg/icl kpc
    sbt_l = [ 26. ]# [  26, 26.5, 27, 27.5, 28. ]
    err_size = 0.2
    pixscale = 0.8 # ''/pixel
    physscale = 1 # kpc/''
    rc = 250 # kpc, distance to center to be classified as gal
